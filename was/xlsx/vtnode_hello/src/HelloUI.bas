Attribute VB_Name = "HelloUI"
'Attribute VB_Name = "WasUIController"
Option Explicit

Private Const MAIN_SHEET As String = "VTNode Hello"
Private Const RUNTIME_SHEET As String = "VTNode Hello"
Private Const ACCESS_URL_CELL As String = "E16"
...
Public Sub UI_InitButtons()
    ...
    Debug.Print "HelloUI.UI_InitButtons"
